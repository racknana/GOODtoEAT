    ...
    var b = "starRating",
        ...
        f = {
            ...
            getIndex: function (b) {
                ...
                return g = .5 > g && b.offsetX < d / 4 ? -1 : g, g = f && f <= this.settings.totalStars && f > g ? f - 1 : g
            },
            ...
            paintStars: function (b, c) {
                ...
                a.each(this.$stars, function (i, j) {
                    d = a(j).find('[data-side="left"]'), e = a(j).find('[data-side="right"]'), f = g = b >= i ? c : "empty", f = i - b === .5 ? c : f, d.attr("class", "svg-" + f + "-" + this._uid), e.attr("class", "svg-" + g + "-" + this._uid);
                    var k, l = b >= 0 ? Math.ceil(b) : 0;
                    k = h.ratedColors && h.ratedColors.length && h.ratedColors[l] ? h.ratedColors[l] : this._defaults.ratedColor, "rated" === c && b > -1 && ((i <= Math.ceil(b) || 1 > i && 0 > b) && d.attr("style", "fill:" + k), b >= i && e.attr("style", "fill:" + k))
                }.bind(this))
            },
            ...
            getSvgDimensions: function (a) {
                return "rounded" === a ? 'width="550px" height="500.2px" viewBox="0 146.8 550 500.2" style="enable-background:new 0 0 550 500.2;' : 'x="0px" y="0px" width="30px" height="30px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305;'
            },
        ...
        g = {
            ...
            resize: function (c) {
                var d = "plugin_" + b,
                    ...
                    f = e.data(d),
                    g = f.$stars;
                return 1 >= c || c > 200 ? void console.error("star size out of bounds") : (g = Array.prototype.slice.call(g), void g.forEach(function (b) {
                    a(b).css({
                        width: c + "px",
                        height: c + "px"
                    })
